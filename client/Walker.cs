...
namespace ZombiesMod.Zombies.ZombieTypes
{
    public class Walker : ZombiePed
    {
        ...
        public Walker(int handle) : base(handle)
        {
        ...
        public override void OnGoToTarget(Ped target)
        {
         ...
         // Méthode pour infecter une cible (à ajouter ici ou dans ZombiePed)
         private void InfectTarget(Ped target)
         {
             // Logique d'infection ici...
         }
    }
}
